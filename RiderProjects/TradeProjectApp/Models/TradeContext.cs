...
public partial class TradeContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=localhost;user=root;password=1234;database=trade", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.38-mysql")).UseLazyLoadingProxies();
